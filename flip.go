...
func RegisterGroup(name string, priority int, cmds ...Command) {
	Base.RegisterGroup(name, priority, cmds...)
}

func (c *Commander) RegisterGroup(name string, priority int, cmds ...Command) {
...
func init() {
	Base = NewCommander(path.Base(os.Args[0]))
}
